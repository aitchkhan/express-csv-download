...
function downloadCsv(req, res) {
  ...
  // stringify gives you a writeable stream, that can be directly piped to "res"
  // since res is an abstraction over http's response object which supports "streams"
